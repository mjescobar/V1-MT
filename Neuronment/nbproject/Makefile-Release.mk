...
${OBJECTDIR}/FunctionsManager.Init.o: FunctionsManager.Init.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Werror -IHeaders -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FunctionsManager.Init.o FunctionsManager.Init.cpp

${OBJECTDIR}/Sources/CommandLine.o: Sources/CommandLine.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sources
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Werror -IHeaders -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sources/CommandLine.o Sources/CommandLine.cpp

${OBJECTDIR}/Sources/Functions.o: Sources/Functions.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sources
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Werror -IHeaders -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sources/Functions.o Sources/Functions.cpp

${OBJECTDIR}/Sources/FunctionsManager.o: Sources/FunctionsManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sources
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Werror -IHeaders -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sources/FunctionsManager.o Sources/FunctionsManager.cpp
...
${OBJECTDIR}/Sources/Interpreter.Init.o: Sources/Interpreter.Init.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sources
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Werror -IHeaders -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sources/Interpreter.Init.o Sources/Interpreter.Init.cpp

${OBJECTDIR}/Sources/Interpreter.o: Sources/Interpreter.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sources
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Werror -IHeaders -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sources/Interpreter.o Sources/Interpreter.cpp

${OBJECTDIR}/Sources/InterpreterCommands.o: Sources/InterpreterCommands.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sources
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Werror -IHeaders -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sources/InterpreterCommands.o Sources/InterpreterCommands.cpp
...
${OBJECTDIR}/Sources/NeuronType.o: Sources/NeuronType.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sources
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Werror -IHeaders -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sources/NeuronType.o Sources/NeuronType.cpp
