...
The following section describes the different aspects of the \gls{neuronmentsequencersyntax} as it required to be used on the development of a \glssymbol{neuronmentprocedure} file.
