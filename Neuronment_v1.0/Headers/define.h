...
#define INTERPRETER_MANAGER_COMMANDS_HASH_SIZE 17
#define LOG_MANAGER_MESSAGES_HASH_SIZE 76
#define SETTINGS_MANAGER_INT_HASH_SIZE 2
...
#define SETTINGS_MANAGER_BOOL_HASH_SIZE 2
