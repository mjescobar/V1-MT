...
${OBJECTDIR}/Sources/Globals.o: Sources/Globals.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Werror -IHeaders -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sources/Globals.o Sources/Globals.cpp
...
${OBJECTDIR}/Sources/InterpreterManager.Initialize.o: Sources/InterpreterManager.Initialize.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sources
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Werror -IHeaders -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sources/InterpreterManager.Initialize.o Sources/InterpreterManager.Initialize.cpp
...
${OBJECTDIR}/Sources/LogManager.Initialize.o: Sources/LogManager.Initialize.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sources
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Werror -IHeaders -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sources/LogManager.Initialize.o Sources/LogManager.Initialize.cpp
...
${OBJECTDIR}/Sources/MT_Neuron.o: Sources/MT_Neuron.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sources
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Werror -IHeaders -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sources/MT_Neuron.o Sources/MT_Neuron.cpp

${OBJECTDIR}/Sources/ND_Neuron.o: Sources/ND_Neuron.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sources
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Werror -IHeaders -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sources/ND_Neuron.o Sources/ND_Neuron.cpp

${OBJECTDIR}/Sources/SettingsManager.Initialize.o: Sources/SettingsManager.Initialize.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sources
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Werror -IHeaders -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sources/SettingsManager.Initialize.o Sources/SettingsManager.Initialize.cpp

${OBJECTDIR}/Sources/SettingsManager.o: Sources/SettingsManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sources
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Werror -IHeaders -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sources/SettingsManager.o Sources/SettingsManager.cpp

${OBJECTDIR}/Sources/SimulationManager.o: Sources/SimulationManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sources
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Werror -IHeaders -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sources/SimulationManager.o Sources/SimulationManager.cpp
...
${OBJECTDIR}/Sources/V1_Neuron.o: Sources/V1_Neuron.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sources
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Werror -IHeaders -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sources/V1_Neuron.o Sources/V1_Neuron.cpp
