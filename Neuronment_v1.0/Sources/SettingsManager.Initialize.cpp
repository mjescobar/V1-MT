...
void SettingsManager::InitializeSimulation()
{
  ...
  Simulation.SetSetting(V1_FIRST_CALCULATION, Data_string, 1);
  ...
  Simulation.SetSetting(V1_A001_NL_MAX, Data_double, 1);
  Simulation.SetSetting(V1_A001_NL_A, Data_double, 1);
  Simulation.SetSetting(V1_A001_NL_B, Data_double, 1);
  // None
  ...
  Simulation.SetSetting(V1_D001_WEIGHT_FACTOR, Data_double, 1);
  ...
  Simulation.SetSetting(MT_FIRST_CALCULATION, Data_string, 1);
  ...
  Simulation.SetSetting(V1V1_CONNECTION_METHOD, Data_string, 1);
  // V1V1_L001 Link Parameters
  Simulation.SetSetting(V1V1_L001_BASE_WEIGHT_SOURCE, Data_string, 1);
  Simulation.SetSetting(V1V1_L001_DEFAULT_WEIGHT, Data_double, 1);
  for (int i = 0; i < MAX_V1_NEURONS; i++) {
